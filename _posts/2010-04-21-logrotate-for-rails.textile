...
On a unixy system, place the above text in a file called @our_app@ in the @/etc/logrotate.d@ directory. Logrotate will now rotate your logs each night.
